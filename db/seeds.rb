...
example_event4 = Event.create({name:"Lindypalooza Whatchakadooza Example",organizer:"Naptown Stomp",date:"2016-11-29",location:"Indianapolis, Indiana",price:30.00,event_type:"Workshop",dance_style:"Lindy"})
