...
actual_event1 = Event.create({name:"Big Red Swing Weekend", organizer:"IU Swing",date:"2016-3-4",address:"107 S Indiana Ave, Bloomington, Indiana",price:40.00,event_type:"Workshop",dance_style:"Lindy"})
