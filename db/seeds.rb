...
example_event2 = Event.create({name:"Dayton Swing Smackdown Example",organizer:"Dayton People",date:"2015-4-13",address:"Dayton, Ohio",price:30.00,event_type:"Workshop",dance_style:"Lindy"})
example_event3 = Event.create({name:"Southern Swing Challenge Example",organizer:"Jon Tigert and Jenna Applegarth",date:"2015-9-23",address:"Nashville, TN",price:30.00,event_type:"Workshop",dance_style:"Lindy"})
